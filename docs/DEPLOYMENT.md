...
Do not run destructive or development migrations automatically in production.
...
That script runs Prisma Client generation and `next build`; it does not run `prisma migrate deploy`.
