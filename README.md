...
5. Run production migrations from a trusted release environment with `npm run prisma:deploy`.
6. Deploy to Vercel. The Vercel build runs `npm run vercel-build`, which generates Prisma Client and builds Next.js without applying migrations.
